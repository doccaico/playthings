...
// if (mem.startsWith(u8, output, "##### ")) {
//     const str = try mem.concat(allocator, u8,  &[_][]const u8{"<h5>", output[6..] ,"</h5>"});
//     try result.append(str);
// } else if (mem.startsWith(u8, output, "###### ")) {
//     const str = try mem.concat(allocator, u8,  &[_][]const u8{"<h6>", output[7..] ,"</h6>"});
//     try result.append(str);
// } else {
//     const str = try mem.concat(allocator, u8,  &[_][]const u8{"<p>", output[0..] ,"</p>"});
//     try result.append(str);
// }
